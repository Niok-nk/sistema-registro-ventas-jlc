<?php
/**
 * API Endpoint: Servir factura (foto de recibo)
 * Method: GET
...
// Verificar que el token sea para el directorio correcto (evita reutilizar ftoken de certificado aquí)
if (($payload['dir'] ?? '') !== 'facturas') {
    http_response_code(403);
...
if (!file_exists($filepath)) {
    ...
    die(json_encode(['status' => 404, 'message' => 'Archivo no encontrado']));
}
...
// Servir el archivo — sin Cache-Control largo para tokens de corta duración
